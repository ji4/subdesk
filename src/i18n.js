(function () {
  ...
  var translations = {
    ...
    'keys.tabNote':   { 'zh-TW': 'Tab / Shift+Tab 也可切換上 / 下一句。<br><span style="font-size:11px;opacity:0.75;">（固定快捷鍵，不可更改。）</span>', 'en': 'Tab / Shift+Tab also navigates prev / next line.<br><span style="font-size:11px;opacity:0.75;">(Fixed shortcut, non-customizable.)</span>' },
    ...
    'dePrompt.titlePost':   { 'zh-TW': '輸入？',       'en': 'input while editing?' },
    'dePrompt.hint':        { 'zh-TW': '右上角快捷鍵設定可隨時更改。', 'en': 'Change this anytime in Shortcuts settings.' },
    'dePrompt.enablePre':   { 'zh-TW': '啟用',         'en': 'Enable' },
    'dePrompt.enableMid':   { 'zh-TW': '變速，停止',   'en': 'speed, stop' },
    'dePrompt.enablePost':  { 'zh-TW': '輸入。',        'en': 'input.' },
    'dePrompt.disablePre':  { 'zh-TW': '維持',          'en': 'Keep' },
    'dePrompt.disablePost': { 'zh-TW': '輸入',          'en': 'as typing keys' },
